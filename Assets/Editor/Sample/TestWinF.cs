...
/// <summary>
/// SubWindow-Custom message box example
/// </summary>
public class TestWinF : MDIEditorWindow {

    [MenuItem("SubWindow example/6.Custom message box example")]
    static void InitWin()
    {
    ...
    private void SubWinA(Rect main)
    {
        ...
        if (GUI.Button(new Rect(main.x, main.y + 20, main.width, 20), "MsgBox test"))
        {
            ShowMsgBox(2, null);
        }
    }
